export const zh = {
  ...
  routinesTrigger: '触发方式',
  routinesTriggerRepeat: '重复',
  routinesTriggerOnce: '一次性',
  routinesEverySeconds: '间隔（秒）',
  routinesAnchorAt: '对齐时刻（可选）',
  routinesAt: '时刻',
  routinesInstantPlaceholder: '2026-09-26T09:00+08:00',
  ...
  routinesEverySummary: '每 {seconds} 秒',
  routinesAtSummary: '一次性 · {at}',
  routinesAnchorSummary: '对齐 {at}',
  routinesOnceSummary: '触发一次后停止',
  routinesRepeatSummary: '持续重复',
  routinesErrorName: '名称只能以字母或数字开头，只含字母、数字、- 和 _',
  routinesErrorMember: '请选择要唤醒的 Agent',
  routinesErrorPrompt: '请填写指令',
  routinesErrorInterval: '间隔必须是至少 60 的整数秒',
  routinesErrorInstant: '时刻要带 offset 或 Z，例如 2026-09-26T09:00+08:00',
  channelName: '名称',
...
export const en = {
  ...
  routinesTrigger: 'Trigger',
  routinesTriggerRepeat: 'Repeating',
  routinesTriggerOnce: 'One-shot',
  routinesEverySeconds: 'Interval (seconds)',
  routinesAnchorAt: 'Phase anchor (optional)',
  routinesAt: 'Instant',
  routinesInstantPlaceholder: '2026-09-26T09:00+08:00',
  ...
  routinesEverySummary: 'Every {seconds}s',
  routinesAtSummary: 'One-shot · {at}',
  routinesAnchorSummary: 'aligned to {at}',
  routinesOnceSummary: 'stops after the first fire',
  ...
  routinesErrorInterval: 'The interval must be a whole number of seconds, at least 60',
  routinesErrorInstant: 'The instant needs an offset or Z, e.g. 2026-09-26T09:00+08:00',
  channelName: 'Name',
